...
public class MedicineRoomdd {
   ...
   String timeRefill ;
    ...
    private static MedicineRoomdd instance = null;

    private MedicineRoomdd() { }

    public static MedicineRoomdd getInstance() {
        if(instance == null){
            instance = new MedicineRoomdd();
        }
        return instance;
    }
    ...
    public MedicineRoomdd(int id, String name, String form, String strength, String reason, String isDaily, String often, String time, String startDate, String endDate, int medLeft, int refillLimit, int image, String Uid, String timeRefill) {
        this.id = id;
        this.name = name;
        this.form = form;
