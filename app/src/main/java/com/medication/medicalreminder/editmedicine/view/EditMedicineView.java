...
public class EditMedicineView extends AppCompatActivity implements AdapterView.OnItemSelectedListener, EditMedicinesViewInterface {
    ...
    TextView enterAmountText, enterRemainText, startDate, endDate;
    CardView cardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Medicine medicine = gson.fromJson(strObj, Medicine.class);
        medicine.setId(1);
    ...
    private void initNumberPicker() {
        ...
        numberPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker numberPicker, int oldValue, int newValue) {
                ...
                Log.i("TAG", "" + medicinePojoo.getStrength());
                Toast.makeText(getApplicationContext(), "" + medicinePojoo.getStrength(), Toast.LENGTH_SHORT).show();
